...
#define UDP_TX_PACKET_MAX_SIZE 544
#define PAYLOAD_SIZE 516

byte FlexMAC[] = {0xDE, 0xAD, 0xBE, 0xEF, 0xFE, 0xED};    // Frisco 6400 MAC address
IPAddress FlexIP(192, 168, 1, 177);                       // Frisco 6400 IP address
IPAddress FlexRouterIP(60,128,1,1);                       // Frisco Gateway IP Address

byte ArduinoMAC[] = {0xDE, 0xAD, 0xBE, 0xEF, 0xFE, 0xED};
IPAddress ArduinoIP(10,19,8,164);
...
void loop() {
  ...
  Udp.write(payload, sizeof(header));
