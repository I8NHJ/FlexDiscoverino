...
char ST0_payload_ip[]                           = "ip=10.19.8.53 ";
...
void loop() {
  ...
  if (digitalRead(connectedPin)) {
    ...
    Udp.write(ST1_payload_callsign,                     sizeof(ST1_payload_callsign));
    Udp.write(ST1_payload_ip,                           sizeof(ST1_payload_ip));
    Udp.write(ST1_payload_port,                         sizeof(ST1_payload_port));
    ...
    Udp.write(ST1_payload_radio_license,                sizeof(ST1_payload_radio_license));
    Udp.write(ST1_payload_requires_additional_license,  sizeof(ST1_payload_requires_additional_license));
...
void calculate_sizes(){
  ...
  packet_size_lo = discovery_words_size;
